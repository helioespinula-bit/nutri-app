...
type Tab = "home" | "meals" | "weight" | "history" | "chat";
...
function App() {
  ...
  function sendChatMessage() {
    ...
    setChatMessages((current) => [
      ...
      {
        from: "nutri",
        text: "Recebi sua mensagem. Nesta etapa, o chat ainda é apenas a interface. A integração com o histórico será conectada depois.",
      },
    ]);
...
function Dashboard({
  ...
  const totalCarbs = demoMeals.reduce(
  ...
  const totalFat = demoMeals.reduce(
    ...
    <div className="page-content">
      <section className="welcome-card">
        <div>
          ...
          <p>
            Consistência &gt; perfeição. O importante é seguir
            acompanhando.
          </p>
        </div>
      ...
      <section className="section-block">
        ...
        <div className="carb-card">
          ...
          <p>
            Ainda há espaço dentro da meta diária de
            carboidratos.
          </p>
        </div>
      </section>
  ...
  return (
    <div className="page-content">
      <section className="page-intro">
        ...
        <p>
          Acompanhe o que foi registrado e observe o conjunto
          do dia.
        </p>
      </section>
...
function WeightScreen() {
  ...
  const current =
    demoWeights[demoWeights.length - 1].value;
  ...
  return (
    <div className="page-content">
      <section className="page-intro">
        ...
        <p>
          Um olhar sobre os registros recentes, sem perder a
          visão do conjunto.
        </p>
      </section>
